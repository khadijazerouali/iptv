...
class Checkout extends Component
{
    ...
    public function submit()
    {
        ...
        Mail::to(env('ADMIN_EMAIL', 'admin@votresite.com'))->send(new \App\Mail\OrderInfoToAdmin($user, $product));
        Mail::to($user->email)->send(new \App\Mail\OrderInfoToClient($user, $product, $this->cart));
